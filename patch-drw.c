--- drw.c.orig	2024-10-24 17:06:07 UTC
+++ drw.c
@@ -61,7 +61,7 @@ Drw *
 }
...
+drw_scm_create(Drw *drw, const char *clrnames[], unsigned int clralphas[], size_t clrcount)
 {
 	size_t i;
 	Clr *ret;
@@ -205,7 +207,7 @@ drw_scm_create(Drw *drw, const char *clrnames[], size_
 		return NULL;
...
@@ -263,9 +265,8 @@ drw_text(Drw *drw, int x, int y, unsigned int w, unsig
 	} else {
